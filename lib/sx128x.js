...
SX128x.prototype._config = async function () {
    ...
    await this.setModulationParams(options.modParams);
    await this.setDioIrqParams(options.irqMask, options.dioMask);
...
SX128x.prototype.send = async function (data) {
    ...
    */
    ...
    if (msg.length <= 252 ){
        ...
        await this.setTx();
        return await this._dio1Gpio.watch(await this.irqParse());
    }
    else{
