...
//Registers
SX128x.REG_LR_PAYLOADLENGTH        = 0x0702;
SX128x.REG_IQ_POLARITY_SETUP       = 0x0736;
SX128x.REG_LR_SYNCWORD             = 0x0740;
SX128x.REG_RX_GAIN                 = 0x08AC;
SX128x.REG_TX_MODULATION           = 0x0889;
SX128x.REG_RFFrequency31_24        = 0x088B;
SX128x.REG_RFFrequency23_16        = 0x088C;
SX128x.REG_RFFrequency15_8         = 0x088D;
SX128x.REG_RFFrequency7_0          = 0x088E;
SX128x.REG_LNA_REGIME              = 0x0891;
...
//pktParam1
SX128x.LORA_PBLE_12_SYMB           = 0x0C;    //12 Symbol Preable
//pktParam2
SX128x.EXPLICIT_HEADER             = 0x00;      //Explicit Header
SX128x.IMPLICIT_HEADER             = 0x80;      //Implicit Header
SX128x.LORA_PKT_VARIABLE_LENGTH    = 0x00;
SX128x.LORA_PKT_FIXED_LENGTH       = 0x80;
...
SX128x.USE_LDO                     = 0x00;
SX128x.USE_DCDC                    = 0x01;

//IRQ Params
SX128x.IRQ_RADIO_NONE              = 0x0000;
SX128x.IRQ_TX_DONE                 = 0x0001;
SX128x.IRQ_RX_DONE                 = 0x0002;
SX128x.IRQ_PREAMBLE_DETECTED       = 0x0004;
SX128x.IRQ_SYNCWORD_VALID          = 0x0008;
SX128x.IRQ_HEADER_VALID            = 0x0010;
SX128x.IRQ_HEADER_ERROR            = 0x0020;
SX128x.IRQ_CRC_ERROR               = 0x0040;
SX128x.IRQ_CAD_DONE                = 0x0080;
SX128x.IRQ_CAD_ACTIVITY_DETECTED   = 0x0100;
SX128x.IRQ_RX_TX_TIMEOUT           = 0x0200;
SX128x.IRQ_TX_TIMEOUT              = 0x0200;
SX128x.IRQ_RX_TIMEOUT              = 0x0200;
SX128x.IRQ_RADIO_ALL               = 0xFFFF;

//Syncword Variables
SX128x.RADIO_RX_MATCH_SYNCWORD_OFF = 0x00;     //no search for SyncWord
SX128x.RADIO_RX_MATCH_SYNCWORD_1   = 0x10;
SX128x.RADIO_RX_MATCH_SYNCWORD_2   = 0x20;
SX128x.RADIO_RX_MATCH_SYNCWORD_1_2 = 0x30;
SX128x.RADIO_RX_MATCH_SYNCWORD_3   = 0x40;
SX128x.RADIO_RX_MATCH_SYNCWORD_1_3 = 0x50;
SX128x.RADIO_RX_MATCH_SYNCWORD_2_3 = 0x60;
SX128x.RADIO_RX_MATCH_SYNCWORD_1_2_3=0x70;

SX128x.PACKET_FIXED_LENGTH         = 0x00;
SX128x.PACKET_VARIABLE_LENGTH      = 0x20;

SX128x.CRC_OFF                     = 0x00;
SX128x.CRC_1_BYTES                 = 0x10;
SX128x.CRC_2_BYTES                 = 0x20;
SX128x.CRC_3_BYTES                 = 0x30;

SX128x.WHITENING_ON                = 0x00;
SX128x.WHITENING_OFF               = 0x08;
