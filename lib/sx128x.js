...
function SX128x (options) {
    ...
    this._modParams = (options.hasOwnProperty('modParams')) ? options.modParams : {spreadingFactor: this.LORA_SF_5, bandwidth:this.LORA_BW_1600, codingRate:this.LORA_CR_4_5};
