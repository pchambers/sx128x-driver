...
SX128x.prototype._config = async function () {
    ...
    await radio.setRegulatorMode();
    await radio.setPacketType(this._packetType);
    await radio.setRFFreq(this._rfFreq);
    await radio.setBufferBaseAddr(this._txBaseAddr, this._rxBaseAddr);
