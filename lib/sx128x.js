...
function SX128x (options) {
    ...
    this._txParams = (options.hasOwnProperty('txParams')) ? options.txParams : {power: 0x1F, rampTime:this.RADIO_RAMP_40_US};
...
SX128x.prototype.setTxParam = async function ({power = 0x1F, rampTime = this.RADIO_RAMP_40_US}) {
