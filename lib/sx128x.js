...
SX128x.prototype.printModemSettings = async function () {
    ...
    this._trace('getLoRaCR4 : ' + this._getLoRaCR());
    ...
    if(this._packetType == this.PACKET_TYPE_FLRC){
        (this._pktParams.pktParam1 == 0) ? this._trace('No Syncword'): null ;
        (this._pktParams.pktParam1 == 4) ? this._trace('32bit Syncword'): null ;
    }
    ...
    switch (this._pktParams.pktParam3) {
        ...
        case this.RADIO_RX_MATCH_SYNCWORD_1_2_3:
            ...
            break;
        default:
            this._trace('Unknown SYNCWORD');
    }
    (this._pktParams.pktParam4 == this.PACKET_FIXED_LENGTH) ? this._trace('Packet Length Fixed'): null ;
    (this._pktParams.pktParam4 == this.PACKET_VARIABLE_LENGTH) ? this._trace('Packet Length Variable') : null ;
...
SX128x.prototype.printOperatingSettings = async function () {
    ...
    switch (this._packetType) {
        ...
        case this._PACKET_TYPE_BLE:
            ...
            break;
        default:
            this._trace('Packet Type Unknown');
    }
