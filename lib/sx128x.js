...
SX128x.prototype.printModemSettings = async function () {
    ...
    if(this._packetType == this.PACKET_TYPE_FLRC){
        (this._pktParams.pktParam1 == 0) ? this._trace('No Syncword'): ;
        (this._pktParams.pktParam1 == 4) ? this._trace('32bit Syncword'): ;
    }
    ...
    (this._pktParams.pktParam4 == this.PACKET_VARIABLE_LENGTH) ? this._trace('Packet Length Variable') : ;
    ...
    (this._pktParams.pktParam7 == this.WHITENING_ON) ? this._trace('Whitening ON') : ;
    (this._pktParams.pktParam7 == this.WHITENING_OFF) ? this._trace('Whitening OFF') :;
};
